...
<About>Features:
Procedural fence tools to art direct fences to fit art styles
Easy to place curves that fences will automatically populate
Plug and play custom fence segments
Randomization sliders to vary look across fences</About>
</Main2>
    </Main>
  );
}